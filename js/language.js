...
const languageContainer = document.getElementsByClassName('language')[0]
...
const knowUsContent = {
    ...
    spanish: [
        'Inicio', 'Servicios', 'Expertos', 'Test diagnóstico', 'Aprende', 'Nosotros', 'Conócenos', 'Contacto', 'Inicia sesión', 'Inicio', 'Expertos', 'Test diagnóstico', 'Aprende', 'Sobre nosotros', 'Contacto', 'DESCUBRE', 'RELYER', '¿Quiénes somos?', '<span class="info-we-give translate">Somos Relyer y a través de nuestra plataforma puedes acceder a recursos y formación de la mano de expertos que te permitirán facilitar y fortalecer el manejo del desarrollo de tu empresa </span><br><span class="info-we-give2">Nuestros pilares abordan todas las etapas del proceso de transformación </span><br> Haz crecer tu empresa, sus colaboradores y su futuro a través de la <span style="font-weight: bold;">transformación digital y cognitiva</span>', 'Profesionales', 'Sugerencias <br> tecnológicas', 'artículos', 'Descubre', 'Nuestro <span style="font-weight: bold;">ADN</span>', 'Porqué Relyer?', 'Valoramos a las personas como individuos y a la familia', 'Trabajamos en equipo con nuestros clientes de manera transparente', 'Somos generadores de ideas y soluciones', 'Equipo', 'Scrum Master', '´Diseñador UI/UX', 'Product Owner', 'Desarrollador backend', 'Desarrollador Frontend', 'Nuestras habilidades', 'Sostenibilidad', 'Adaptación', 'Crecimiento', 'Lo que dicen nuestros clientes ', '', '', 'Ustedes son increibles, no puedo creer todo el apoyo que he recibido y el crecimiento , gracias', ' Realmente estoy agradecida por el impacto tan positivo que han tenido en mi negocio y por la orientación que me han dado 10/10', 'Aumente mis ventas 3 veces en solo un par de meses, gracias Relyer', 'Al principio tenía mis dudas como cualquier persona, pero rapidamente supe que había sido una buena desición', 'Muy buen servicio, una experiencia muy linda'
    ],
    english: [
        'Home', 'Services', 'Experts & Tools', 'Diagnosis Test', 'Learn more', 'About us', 'know us', 'Contact', 'Login/Register', 'Home', 'Experts & Tools', 'Diagnosis Test', 'Learn more', 'About us', 'know us', 'DISCOVER', 'RELYER', 'Who are we?', '<span class="info-we-give translate">We are Relyer and with our platform you can access to many resources, and grow your company always adviced by experts </span><br><span class="info-we-give2">   We are part of all the processes of the digital transformation  </span><br> Grow your company, and buld the future with the hand of the <span style="font-weight: bold;">digital transformation</span> ', 'Professionals', 'Tech suggestions', 'Articles', 'Discover', 'Our <span style="font-weight: bold;">ADN</span>', 'Why Relyer?', 'We appreciate people as human beings and family ', 'We work with our clients with open processes', 'We are generators of solutions and ideas', 'TEAM', 'Scrum Master', 'UI/UX designer', 'Product Owner', 'Backend developer'
        , 'Frontend developer ', 'OUR SKILLS', 'Sustainability', 'Adaptation', 'Growth', 'What our clients say', '', '', '"You guys are amazing, my company went somewhere I didnt believe possible with all the feedback and tools, thank you so much, worth every penny"', '"Im spechless for all the things I learnt and the way my entrepreneur ideas went high, thank you so much, relyer forever"', '" I sincerely can say that it was really great, you might think is just a common test, but is somethigng really brand new, and you have the best guidance in what you need"', '" I mean like just can say 2 words , thank you"', '" When you give your best and youre guided by the best success is a joke to you"'
    ]

}

// USE THE CONTENT OF YOUR PAGE
switch (currentPage) {

    case "aboutUs.html":
        pageContent = 'knowUsContent'
        break;
