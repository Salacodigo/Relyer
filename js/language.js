...
const homeContent = {
	spanish: [
		...
		"Contacto",
		"Relyer",
		"Somos la conexión entre pequeños <br> empresarios y soluciones tecnológicas,<br> organizacionales y culturales, así como <br> expertos y recursos de aprendizaje",
		...
		"No importa si se te dificultan <br> las nuevas tecnologías o el ambiente digital o si tienes previa <br> experiencia",
		'Te ayudamos a dar tu <span class="first">Primer paso</span>',
		"Empresas que confían en nosotros",
		'<span class="statistics-numbers ">+100</span> <br>Empresas',
		'<span class="statistics-numbers ">+4.5</span> <br>Puntaje',
		'<span class="statistics-numbers ">2</span> <br>idiomas',
		"COMIENZA AHORA",
	...
	english: [
		...
		"know us",
		"Relyer",
		"We are the connection between <br> the micro-entrepreneurs and <br> technological, organizational & <br> cultural solutions and methods",
		...
		"Identify",
		"You can either find possible <br> issues by yourself or with our <br> diagnosis",
		"Learn",
		"Discover how tech tools and <br> methodologies can take you <br> the next level with experts <br> guide",
		"Apply",
		" Use the concepts learnt and <br> see the expansion of your <br> company/ business",
		"It doesn’t matter whether you’re struggling with managing devices and tech, or if you already have more experience",
		'We’ll help you make your <span class="first">First step</span>',
		"Enterprises that support us",
		' <span class="statistics-numbers ">+100</span> <br> Companies',
		' <span class="statistics-numbers ">+4.5</span> <br> Rating',
		'<span class="statistics-numbers ">3</span> <br>Language',
		"START NOW",
...
const knowUsContent = {
	...
	english: [
		...
		"RELYER",
		"Who are we?",
		'<span class="info-we-give translate">We are Relyer and with our platform you can access to many resources, and grow your company always adviced by experts </span><br><span class="info-we-give2">   We are part of all the processes of the digital transformation  </span><br> Grow your company, and buld the future with the hand of the <span style="font-weight: bold;">digital transformation</span> ',
		"Professionals",
		"Tech suggestions",
		"Articles",
		"Discover",
