const questions = [
	{
		pregunta:
			"¿Conoces las herramientas disponibles para digitalizar tu negocio?",
		respuestas: {
	...
	{
		pregunta:
			"¿Qué importancia tienen los datos en la estrategia y forma de hacer negocio de su comercio?",
		respuestas: {
	...
	{
		pregunta:
			"¿Utilizas estos canales digitales para la promoción de tu negocio?",
		respuestas: {
			a: "No",
	...
	{
		pregunta:
			"¿Utilizas estos canales digitales para vender tus productos y/o servicios?",
		respuestas: {
			a: "No",
	...
	{
		pregunta:
			"¿Cuáles de las siguientes herramientas dispones en tu negocio para la comunicación y colaboración con tus clientes?",
		respuestas: {
	...
	{
		pregunta:
			"¿Cuál de las siguientes herramientas digitales son utilizadas para la gestión de tu negocio?",
		respuestas: {
			a: "Ninguna",
