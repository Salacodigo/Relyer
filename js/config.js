        ...
        */
		if (element.type == 0) {
			contenedor.innerHTML +=
				'<div class="card">' + '<h2 class="preguntas">' + element.question + "</h2>" + '<div class="opciones" id="card' + contador + '"></div></div>';
			...
			result.forEach(valor => {
				...
				if (valor.answer == "Otros (Especifique)") {
					contenedorOpciones[m].innerHTML +=
			...
			result.forEach(valor => {
				...
				if (valor.answer == "Ninguno" || valor.answer == "No" || valor.answer == "Ninguna") {
					contenedorOpciones[m].innerHTML +=
						'<input type="checkbox" onchange="Checked2(' +
						contador +
						"," +
						comilla +
						valor.uid +
			...
			contenedor.innerHTML +=
				'<div class="card">' + '<h2 class="preguntas">' + element.question + "</h2>" + '<div class="opciones" id="card' + contador + '"></div>';
			("</div>");
...
button.addEventListener("click", async () => {
	...
	for (let element of options) {
		let validation = document.getElementsByName(element.id);
